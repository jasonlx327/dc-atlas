...
export default function Home({ initialPayload = null }: { initialPayload?: Partial<AtlasPayload> | null }) {
  ...
  return <main id="top">
    ...
    <section className="column-feature" id="columns" aria-labelledby="featured-column-title"><div className="column-feature-head"><span>NEW · IDC ATLAS COLUMN</span><time dateTime="2026-07-28">2026 / 07 / 28</time></div><a className="column-feature-card" href="/columns/hyperscale-idc-leases"><div><p>LEASE WATCH · 02</p><h2 id="featured-column-title">GW 级长租，<br /><em>正在改写 IDC 订单。</em></h2><p>从 CoreWeave、Digital Realty 与世纪互联的最新公开合同，拆解头部互联网和云客户如何提前锁定第三方 IDC 容量。</p><dl><div><dt>APLD</dt><dd>400 MW</dd></div><div><dt>CORZ</dt><dd>590 MW</dd></div><div><dt>VNET</dt><dd>510 MW</dd></div></dl><span>阅读全文 <ArrowIcon /></span></div><figure><img src="/column-hyperscale-leases.png" alt="由长期容量合同连接的超大规模数据中心园区" loading="eager" /><figcaption>ORIGINAL IDC ATLAS EDITORIAL</figcaption></figure></a><a className="column-archive-link" href="/columns/ai-capex-power"><span>PREVIOUS · CAPEX WATCH 01</span><strong>AI 基建竞赛进入电力时代</strong><small>Microsoft、Alphabet、Meta 与 Amazon 的资本开支传导 →</small></a></section>
