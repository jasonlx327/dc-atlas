...
export default function EnglishHome({ initialPayload = null }: { initialPayload?: Partial<AtlasPayload> | null }) {
  ...
  return <main className="english-home-page english-full-page" lang="en">
    ...
    <section className="column-feature english-column-feature" id="columns" aria-labelledby="english-featured-column-title"><div className="column-feature-head"><span>NEW · IDC ATLAS COLUMN</span><time dateTime="2026-07-28">JULY 28, 2026</time></div><a className="column-feature-card" href="/en/columns/hyperscale-idc-leases"><div><p>LEASE WATCH · 02</p><h2 id="english-featured-column-title">Gigawatt Leases Are <em>Reshaping the Data Center Market.</em></h2><p>The latest CoreWeave, Digital Realty and VNET contracts show how major cloud and internet customers are reserving third-party capacity years before delivery.</p><dl><div><dt>APLD</dt><dd>400 MW</dd></div><div><dt>CORZ</dt><dd>590 MW</dd></div><div><dt>VNET</dt><dd>510 MW</dd></div></dl><span>READ THE COLUMN →</span></div><figure><img src="/column-hyperscale-leases.png" alt="A hyperscale data center campus linked by long-term capacity contracts" loading="eager" /><figcaption>ORIGINAL IDC ATLAS EDITORIAL</figcaption></figure></a><a className="column-archive-link" href="/en/columns/ai-capex-power"><span>PREVIOUS · CAPEX WATCH 01</span><strong>The AI Buildout Enters Its Power-Hungry Phase</strong><small>Microsoft, Alphabet, Meta and Amazon CapEx transmission →</small></a></section>
