...
export default function EnglishHome({ initialPayload = null }: { initialPayload?: Partial<AtlasPayload> | null }) {
  ...
  return <main className="english-home-page english-full-page" lang="en">
    <header className="english-nav"><a href="/en" aria-label="IDC Atlas English home">IDC <b>ATLAS</b></a><nav aria-label="English site navigation"><a href="#pulse">Latest</a><a href="#calendar">Earnings</a><a className="english-columns-nav" href="/en/columns" target="_blank" rel="noreferrer">Columns ↗</a><a href="#chain">Supply chain</a><a href="#silicon">China silicon</a><a href="#market">Markets</a></nav><a className="language-switch active" href="/">中文</a></header>
