...
export default function Home() {
  ...
  return <main id="top">
    ...
    <footer><Brand /><p>全球数据中心产业地图与实时情报站</p><div className="footer-contact"><SiteQrCode /><a href="https://github.com/jasonlx327" target="_blank" rel="noreferrer"><GithubIcon /><span><strong>GitHub</strong><small>@jasonlx327</small></span><ExternalIcon /></a><a className="privacy-link" href="/privacy">隐私说明</a><span>RESEARCH ONLY · NOT INVESTMENT ADVICE</span></div></footer>
  </main>;
}
